...
namespace PCS4EXAM
{
    public class StartUp : IComparable<StartUp>
    {
        ...
        public delegate void TresholdReachedHandler(StartUp s);
        public event TresholdReachedHandler thresholdReached;
        ...
        public void addDonation (String nameDonator, int amount)
        {
            ...
            if(getTotalOfDonations() >= this.threshold)
            {
                if (thresholdReached != null)
                {
                    thresholdReached(this);
                }
            }
        }
