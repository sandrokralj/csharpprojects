   ...
   public class CrowdFunding
    {
        ...
        /// <summary>
        /// returns the list of all startups
        /// </summary>
        /// <returns></returns>
        ...
        {
            //todo, assignment 1
            this.startups.Sort(new Comparison<StartUp>(this.sortByNumberOfDonationsAndName));

        }


        public int sortByNumberOfDonationsAndName(StartUp first, StartUp second)
        {
            int numDonations = first.getNrOfDonations() - second.getNrOfDonations();
            if(numDonations == 0)
            {
