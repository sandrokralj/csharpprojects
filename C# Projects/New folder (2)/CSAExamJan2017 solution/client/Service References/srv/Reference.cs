...
namespace RentClient.srv {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="srv.IService", CallbackContract=typeof(RentClient.srv.IServiceCallback))]
    public interface IService {
        ...
        RentClient.srv.House[] GetAvailableHouses();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetAvailableHouses", ReplyAction="http://tempuri.org/IService/GetAvailableHousesResponse")]
        System.Threading.Tasks.Task<RentClient.srv.House[]> GetAvailableHousesAsync();
        ...
        RentClient.srv.OfferStatus MakeAnOffer(string address, int offer);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/MakeAnOffer", ReplyAction="http://tempuri.org/IService/MakeAnOfferResponse")]
        System.Threading.Tasks.Task<RentClient.srv.OfferStatus> MakeAnOfferAsync(string address, int offer);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChannel : RentClient.srv.IService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceClient : System.ServiceModel.DuplexClientBase<RentClient.srv.IService>, RentClient.srv.IService {
        ...
        public RentClient.srv.House[] GetAvailableHouses() {
            return base.Channel.GetAvailableHouses();
        }
        
        public System.Threading.Tasks.Task<RentClient.srv.House[]> GetAvailableHousesAsync() {
            return base.Channel.GetAvailableHousesAsync();
        }
        
        public RentClient.srv.OfferStatus MakeAnOffer(string address, int offer) {
            return base.Channel.MakeAnOffer(address, offer);
        }
        
        public System.Threading.Tasks.Task<RentClient.srv.OfferStatus> MakeAnOfferAsync(string address, int offer) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAdminChannel : RentClient.srv.IAdmin, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AdminClient : System.ServiceModel.ClientBase<RentClient.srv.IAdmin>, RentClient.srv.IAdmin {
